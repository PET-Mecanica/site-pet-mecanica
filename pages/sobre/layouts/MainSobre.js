    ...
    render(){
        ...
        return(
            ...
            <Container className="row justify-content-between" style={{display: 'flex', alignItems: 'center', padding: '80px 0', maxWidth: '1280px'}}>
                <Grid item xs={5}>
                    <img src="/trol.png" className="float-left trol"></img>
                <img src="/interno.jpg" className='float-left' style={{
                    width: 'auto', height: 'auto', maxWidth: '500px', maxHeight: '600px'
                    }}/>
                </Grid>
                <Grid item xs={6}>
                <h1 className="h1-center">O PET-MECÂNICA DA ESCOLA POLITÉCNICA DA USP</h1>
            ...
            <Container className="row justify-content-between" style={{display: 'flex', alignItems: 'center', padding: '80px 0', maxWidth: '1280px'}}>
                <Grid item xs={6}>
                <h1 className="h1-center">O PET NO BRASIL</h1>
                ...
                <Grid item xs={5}>
                <img src="/brasil.png" className='float-left' style={{
                    width: 'auto', height: 'auto', maxWidth: '500px', maxHeight: '600px'
                    }}/>
                </Grid>
                </Container>
